...
class App extends Component {
  ...
  getGISData() {
    ...
    axios.get('https://stormy-harbor-53517.herokuapp.com/api/gis')
  ...
  getRegions(country, state) {
    ...
    return axios.get(`https://stormy-harbor-53517.herokuapp.com/api/regions?country=${country}&state=${state}`)
  }
  ...
  getRegionInfo(country, state, county) {
    ...
    return axios.get(`https://stormy-harbor-53517.herokuapp.com/api/graphinfo?country=${country}&state=${state}&county=${county}`)
  }
  ...
  render() {
    return (
      <Layout>
        ...
        <Footer style={{ textAlign: "center" }}>Data taken from MongoDB</Footer>
      </Layout >
